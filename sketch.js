...
function setup() {
	...
	packageBody = Bodies.circle(width/2 , 200 , 23, {restitution:0, isStatic:true});
	...
	box2=createSprite(500, 590, 20, 100);
	box2.shapeColor=color(255, 0, 0);
	box2Body = Bodies.rectangle(500, 590 , 20, 100, {isStatic:true});
	World.add(world, box2Body);
 
	box3=createSprite(300, 590, 20, 100);
	box3.shapeColor=color(255, 0, 0);
	box3Body = Bodies.rectangle(300, 590 , 20, 100, {isStatic:true});
